(function (global, factory) {
  ...
  typeof define === 'function' && define.amd ? define('scripts', ['exports', 'jquery'], factory) :
  (factory((global.scripts = {}),global.$));
  ...
  var Vmcharts = function ($$$1) {
    return {
      compatible_view: function compatible_view() {
        // #UT-VMCharts1
        $$$1('.container--chart:not(.chart--line) .chart .data').each(function (index) {
          var $this = $$$1(this);
          $this.css({
        ...
        $$$1('.chart--line .chart .data').each(function (index) {
          var $this = $$$1(this);
          $this.css({
            'bottom': $this.attr('data-percent') + '%'
          });
        }); // #UT-VMCharts3

        $$$1('.chart .chart__y-axis .group').each(function (index) {
          var $this = $$$1(this);
          $this.css({
            'height': $this.attr('data-percent') + '%'
          });
        ...
        $$$1('.chart .chart__x-axis .guideline').each(function (index) {
          var $this = $$$1(this);
          $this.css({
            'height': $this.attr('data-percent') + '%'
          });
        ...
        $$$1('.chart--stacked .chart .data').each(function (index) {
          var $this = $$$1(this);
          $this.css({
            'flex': '0 0 ' + $this.attr('data-percent') + '%'
          });
        }); // TO DO: Unit test

        $$$1('.chart--linear-pie .chart .data').each(function (index) {
          var $this = $$$1(this);
          $this.css({
            'flex': '0 0 ' + $this.attr('data-percent') + '%'
          });
        ...
        $$$1('.container--chart').each(function (index) {
          var $this = $$$1(this);
          ...
          if (style != "" && typeof style != "undefined") {
            ...
            var inlinestyles = "";
            $$$1(arrStyles).each(function (index) {
              if (this == "") return;
              var rule = this.split(':');
      ...
      setDataSet: function setDataSet(chart_id, set) {
        // #UT-VMCharts5
        $$$1('#' + chart_id).attr('data-set', set); // Charts

        $$$1('#' + chart_id + ' .group .data:nth-of-type(' + set + ')').toggleClass('selected'); // Line charts

        $$$1('.chart--line #' + chart_id + ' svg:nth-of-type(' + set + ')').toggleClass('selected'); // Pie charts

        $$$1('.chart--pie #' + chart_id + ' svg circle:nth-of-type(' + set + ')').toggleClass('selected');
        $$$1('.chart--pie #' + chart_id + ' ul li:nth-child(' + set + ')').toggleClass('selected');
      },
      init: function init() {
        // Turn the key into a series of buttons
        $$$1('.key__btn').attr('role', 'button');
        $$$1('body').on("click", ".key__btn", function (e) {
          var $this = $$$1(this);
          var chart_id = $this.attr('data-chartid');
          var set = $this.attr('data-index');

          if (set == "all") {
            $$$1('#' + chart_id + ' .selected').removeClass('selected');
            $$$1('.key__btn[data-chartid="' + chart_id + '"]').removeClass('active');
          } else if ($this.hasClass('active')) {
            $this.removeClass('active');
            Vmcharts.setDataSet(chart_id, set);
          } else {
            $$$1('.key__btn--clear[data-chartid="' + chart_id + '"]').addClass('show');
            $this.addClass('active');
            $$$1('#' + chart_id).addClass('active');
            Vmcharts.setDataSet(chart_id, set);
          } // If not buttons are selected


          if ($$$1('.key__btn[data-chartid="' + chart_id + '"].active').length == 0) {
            $this.removeClass('active');
            $$$1('#' + chart_id).removeAttr('data-set');
            $$$1('#' + chart_id).removeClass('active');
            $$$1('.key__btn--clear[data-chartid="' + chart_id + '"]').removeClass('show');
          }
        });
        $$$1('body').on("mouseenter", ".chart .data", function (e) {
          var index = $$$1(this).attr('data-index');
          var $chart = $$$1(this).closest('.chart');
  ...
  (function ($$$1) {
    ...
    Vmcharts.init(); // Add our modules into a gloabl variable so that we can grab them to test them
